...
from craigslistbargain.neural.generator import get_generator
from craigslistbargain.sessions.neural_session import PytorchNeuralSession
from craigslistbargain.sessions.tom_session import PytorchNeuralTomSession
from craigslistbargain.neural import rl_model_builder, get_data_generator, make_model_mappings
from craigslistbargain.neural.preprocess import markers, TextIntMap, Preprocessor, Dialogue
from craigslistbargain.neural.batcher_rl import DialogueBatcherFactory
from craigslistbargain.neural.utterance import UtteranceBuilder
from craigslistbargain.neural.nlg import build_nlg_module
from craigslistbargain.neural.batcher_rl import RawBatch
import sys
import re
...
class PytorchNeuralSystem(System):
    ...
    def __init__(self, args, schema, price_tracker, model_path, timed, name=None, id=0):
        ...
        nlg_module = build_nlg_module(args)
