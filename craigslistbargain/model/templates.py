...
from craigslistbargain.core.tokenizer import detokenize
from craigslistbargain.analysis.dialogue import Utterance, Dialogue
from craigslistbargain.analysis.speech_acts import SpeechActAnalyzer
...
class TemplateExtractor(object):
    ...
    def detokenize_templates(self):
        #for k, temps in self.templates.items():
        #    for temp in temps:
