...
# =========================
# Generic OpenAI-compatible NLG config
# 可用环境变量覆盖：
# LLM_NLG_MODEL, LLM_NLG_API_BASE, LLM_NLG_API_KEY_ENV
# =========================
LLM_NLG_MODEL="${LLM_NLG_MODEL:-gpt-4o-mini}"
LLM_NLG_API_BASE="${LLM_NLG_API_BASE:-https://api.openai.com/v1}"
LLM_NLG_API_KEY_ENV="${LLM_NLG_API_KEY_ENV:-OPENAI_API_KEY}"
LLM_NLG_TEMPERATURE="${LLM_NLG_TEMPERATURE:-0.2}"
LLM_NLG_TIMEOUT="${LLM_NLG_TIMEOUT:-30}"
LLM_NLG_MAX_RETRIES="${LLM_NLG_MAX_RETRIES:-2}"
LLM_NLG_CACHE_PATH="${LLM_NLG_CACHE_PATH:-cache/llm_nlg_cache.json}"
