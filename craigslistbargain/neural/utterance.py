...
from craigslistbargain.neural.symbols import markers, category_markers
...
class UtteranceBuilder(BaseUtteranceBuilder):
    ...
    def get_price_number(self, entity, kb):
        ...
        val = entity_to_value(raw_price)
        # print(
        #     "DEBUG get_price_number:",
        #     "role=", kb.facts['personal']['Role'],
        #     "entity_in=", entity,
        #     "target=", kb.facts['personal'].get('Target'),
        #     "bottomline=", kb.facts['personal'].get('Bottomline'),
        #     "list_price=", kb.facts['item'].get('Price'),
        #     "raw_price=", raw_price,
        #     "value_out=", val,
        # )
        return val
